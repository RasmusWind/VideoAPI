...
# SECRET_KEY = "django-insecure-5ar)49&7&&iyz^r&pb3w14wzfi+b42m8n(%r)cg75ky1ddsx$i"
...
CSRF_TRUSTED_ORIGINS = ['http://*', 'https://*', 'ws://*']
...
ASGI_APPLICATION = 'videoapi.asgi.application'
